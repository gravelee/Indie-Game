...
class Snake(Creature):
    ...
    ATTACKS             = frozenset(("snake_bite", "snake_tail slam"))
    ABILITY_STATES      = frozenset(("attack_bite","attack_tail slam"))
    COMBAT_STATES       = frozenset(("enter_stance", "idle_attack", "chase", "attack_bite","attack_tail slam"))
